            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={`chapter-${index}`} className="card hover:shadow-hover transition-shadow">
                    <div className="flex items-start space-x-4">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { id: 'sophie', name: 'Sophie M.', text: 'Méthode claire et résultats immédiats ! Mes radis roses sont magnifiques.', rating: 5 },
                  { id: 'marc', name: 'Marc L.', text: 'Parfait pour débuter. J\'ai économisé 50€ sur mes légumes le premier mois.', rating: 5 },
                  { id: 'julie', name: 'Julie R.', text: 'Les recettes sont délicieuses. Mes invités sont impressionnés par la fraîcheur !', rating: 5 }
                ].map((testimonial) => (
